...
document.querySelectorAll('.buttons button').forEach(button => {
    button.addEventListener('click', function () {
        if (button.innerText === "services") {
            ...
            alert("Here at Yaya shopping, we have decided not to be specific with the payment method. We let our customers choose what they like, either using cash, paying using their phones, or even cards!");
